...
export default function AdminPanel({ content, onContentChange }) {
  ...
  async function addProject(event) {
    ...
    try {
      ...
      const next = { ...content, projects: [...content.projects, { id: crypto.randomUUID(), title: form.get("projectTitle"), type: form.get("projectType"), description: form.get("projectDescription"), coverUrl, videoUrl }] };
